...
{	
	...
	public static State fromString(String str)
	{
		switch(str)
		{
		case "Antarctica": return State.Antarctica;
		case "Canberra": return State.Canberra;
		case "New South Wales": return State.NewSouthWales;
		case "Northern Territory": return State.NorthernTerritory;
		case "Queensland": return State.Queensland;
		case "South Australia": return State.SouthAustralia;
		case "Tasmania": return State.Tasmania;
		case "Victoria": return State.Victoria;
		case "Western Australia": return State.WesternAustralia;
		default: return null;
		}
	}
}
